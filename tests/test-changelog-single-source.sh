...
CANON=skills/context/references/changelog-format.md
FAIL=0
...
grep -q 'context/references/changelog-format.md' skills/release/references/changelog-format.md \
    || { echo "FAIL: release/changelog-format.md does not cite the canonical"; FAIL=1; }

# module-create no longer ships its own CHANGELOG template.
[ ! -f skills/module-create/templates/CHANGELOG.md ] \
