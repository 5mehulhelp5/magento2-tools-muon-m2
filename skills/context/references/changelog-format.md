...
touched by the magento2-tools skill pack. `docs` renders it (scaffold),
`release` populates it (commit → category mapping, generation procedure), and
`module-create` delegates to `docs` for it. Do not fork this
