...
Follow the shared rule in `fix/references/commit-format.md`: **do not hard-code
...
Feature: {FeatureName}
Contributing skills: feature, module-create
...
Module(s): Acme_OrderS3Export
Feature: OrderS3Export
Contributing skills: feature, review
...
for the active model (see the rule above and `fix/references/commit-format.md`).
