...
Cross-module checks; see `security/scripts/cross-module-scan.sh` for the
authoritative implementation. The review-skill version runs in single-module scope and
flags:
...
`security/references/pci-context.md` for the severity-bump rules.
