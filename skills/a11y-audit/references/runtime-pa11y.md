...
- Finding shape: `context/references/findings-schema.md`
- Severity scale: `context/references/severity.md`
- Runtime tooling policy: `context/references/runtime-test-tooling.md`
...
3. `pa11y` is listed as available in `{ctx.tools}` (resolved by `context`).
